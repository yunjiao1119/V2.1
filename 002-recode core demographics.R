...
nda18 = readRDS("E:/ABCD study/R/Outputs/nda18_step1.Rds")
...
# income - 3 levels
household.income.3level = nda18$demo_comb_income_v2b
household.income.3level[nda18$demo_comb_income_v2b == "1"] = 1 # "[<50K]"
household.income.3level[nda18$demo_comb_income_v2b == "2"] = 1 # "[<50K]"
household.income.3level[nda18$demo_comb_income_v2b == "3"] = 1 # "[<50K]"
household.income.3level[nda18$demo_comb_income_v2b == "4"] = 1 # "[<50K]"
household.income.3level[nda18$demo_comb_income_v2b == "5"] = 1 # "[<50K]"
household.income.3level[nda18$demo_comb_income_v2b == "6"] = 1 # "[<50K]"
household.income.3level[nda18$demo_comb_income_v2b == "7"] = 2 # "[>=50K & <100K]"
household.income.3level[nda18$demo_comb_income_v2b == "8"] = 2 # "[>=50K & <100K]"
household.income.3level[nda18$demo_comb_income_v2b == "9"] = 3 # "[>=100K]"
household.income.3level[nda18$demo_comb_income_v2b == "10"] = 3 # "[>=100K]"
household.income.3level[nda18$demo_comb_income_v2b == "777"] = NA
household.income.3level[nda18$demo_comb_income_v2b == "999"] = NA
household.income.3level[household.income.3level %in% c(NA, "999", "777")] = NA
nda18$household.income.3level = factor( household.income.3level, levels= 1:3, labels = c("[<50K]", "[>=50K & <100K]", "[>=100K]") )

# income - 4 levels

household.income.4level = nda18$demo_comb_income_v2b
household.income.4level[nda18$demo_comb_income_v2b == "1"] = 1 # "[<50K]"
household.income.4level[nda18$demo_comb_income_v2b == "2"] = 1 # "[<50K]"
household.income.4level[nda18$demo_comb_income_v2b == "3"] = 1 # "[<50K]"
household.income.4level[nda18$demo_comb_income_v2b == "4"] = 1 # "[<50K]"
household.income.4level[nda18$demo_comb_income_v2b == "5"] = 1 # "[<50K]"
household.income.4level[nda18$demo_comb_income_v2b == "6"] = 1 # "[<50K]"
household.income.4level[nda18$demo_comb_income_v2b == "7"] = 2 # "[>=50K & <100K]"
household.income.4level[nda18$demo_comb_income_v2b == "8"] = 2 # "[>=50K & <100K]"
household.income.4level[nda18$demo_comb_income_v2b == "9"] = 3 # "[>=100K & < 200K]"
household.income.4level[nda18$demo_comb_income_v2b == "10"] = 4 # "[>=200K]"
household.income.4level[nda18$demo_comb_income_v2b == "777"] = NA
household.income.4level[nda18$demo_comb_income_v2b == "999"] = NA
household.income.4level[household.income.4level %in% c(NA, "999", "777")] = NA
nda18$household.income.4level = factor( household.income.4level, levels= 1:4, labels = c("[<50K]", "[>=50K & <100K]", "[>=100K & < 200K]", "[>=200K]") )
...
bl.vars=c("married.or.livingtogether","married","high.educ","household.income.3level","household.income.4level") 
...
saveRDS(nda18, "E:/ABCD study/R/Outputs/nda18_step2.Rds")
